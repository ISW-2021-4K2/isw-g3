...
const ciudades = [
  ...
  {
    label: "Carlos Paz",
    value: { latitude: -31.416995, longitude: -64.494201 },
  },
  {
    label: "Río Primero",
    value: { latitude: -31.330088, longitude: -63.620538 },
  },
];
...
function LoQueSeaScreen({ navigation }) {
  ...
  const { register, handleSubmit, setValue, errors, trigger, getValues } =
    useForm({
  ...
  const onSubmit = (data) => {
    ...
    setResumenData({ ...data, distancia: 55555 });
    ...
    <Screen separate style={styles.screen}>
      ...
      <ScrollView>
        ...
        <TextInput
          ...
          onImageExceed={() =>
            setPopUpMessage("La imagen no puede superar los 5 mb")
          }
          onImageNotJpg={() =>
            setPopUpMessage("Por favor ingrese un archivo con formato .jpg")
          }
          onChangeText={(text) => {
        ...
        <View style={styles.botones}>
          <Button
            ...
            buttonStyle={{ backgroundColor: colors.c2 }}
          />
      ...
      <Resumen
        ...
        data={{ ...getValues(), distancia: distance(coordinate, coordinate2) }}
      />
      <PopUp
